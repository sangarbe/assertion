...
func TestAssertion_AllAssertMethodsReturnKo(t *testing.T) {
	data := []struct {
		...
		{"EqualBool", []interface{}{true, false}, "true is not false"},
		{"True", []interface{}{false}, "false is not true"},
		{"False", []interface{}{true}, "true is not false"},
		...
		{"EqualFloat32", []interface{}{1.5, 0.5}, "1.50 is not equal 0.50"},
		{"EqualFloat64", []interface{}{1.5, 0.5}, "1.50 is not equal 0.50"},
		...
		{"LowerThanOrEqualInt", []interface{}{1, 0}, "1 is not lower than or equal 0"},
		{"Email", []interface{}{"plainaddress"}, "email plainaddress is invalid"},
		{"Email", []interface{}{"#@%^%#$@#$@#.com"}, "email #@%^%#$@#$@#.com is invalid"},
		{"Email", []interface{}{"@example.com"}, "email @example.com is invalid"},
		{"Email", []interface{}{"Joe Smith <email@example.com>"}, "email Joe Smith <email@example.com> is invalid"},
		{"Email", []interface{}{"email.example.com"}, "email email.example.com is invalid"},
		{"Email", []interface{}{"email@example@example.com"}, "email email@example@example.com is invalid"},
		{"Email", []interface{}{".email@example.com"}, "email .email@example.com is invalid"},
		{"Email", []interface{}{"email.@example.com"}, "email email.@example.com is invalid"},
		{"Email", []interface{}{"email..email@example.com"}, "email email..email@example.com is invalid"},
		{"Email", []interface{}{"あいうえお@example.com"}, "email あいうえお@example.com is invalid"},
		{"Email", []interface{}{"email@example.com (Joe Smith)"}, "email email@example.com (Joe Smith) is invalid"},
		{"Email", []interface{}{"email@example"}, "email email@example is invalid"},
		{"Email", []interface{}{"email@-example.com"}, "email email@-example.com is invalid"},
		{"Email", []interface{}{"email@example-.com"}, "email email@example-.com is invalid"},
		{"Email", []interface{}{"email@example..com"}, "email email@example..com is invalid"},
		{"Email", []interface{}{"Abc..123@example.com"}, "email Abc..123@example.com is invalid"},
		{"Email", []interface{}{"first last@example.com"}, "email first last@example.com is invalid"},
		{"Email", []interface{}{"test@" + strings.Repeat("subd.", 50) + "com.es"}, "email test@" + strings.Repeat("subd.", 50) + "com.es is invalid"},
		{"Email", []interface{}{"test@0.0.0.0"}, "email test@0.0.0.0 is invalid"},
	}
